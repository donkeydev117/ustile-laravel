                        ...
                        <div class="view">
                            ...
                            @for ($i=1;$i<20;$i++ )
                                ...
                                <img 
                                    id="card_image{{$i}}"
                                    style="border:2px solid #ccc;"
                                    src="{{ asset('assets/images/prototypes/card-styles/banner'.$i.'.jpg') }} "
                                >
                ...
                <div class="form-group">
                    <div class="select-group">
                        <select class="form-control" style="border: 1px solid grey;" onchange="showNewsImage();"
                            ...
                            @for ($i=0; $i < 5 ;$i++ )
                                @if (getSetting()['product_detail'] == 'style'.$i)
                                <option selected="" value="style{{$i}}">Product Page {{ $i+1 }}</option>

                                @else
                                <option value="style{{$i}}">Product Page {{ $i+1 }}</option>
                ...
                <div class="form-group">
                    <div class="select-group">
                        <select class="form-control" style="border: 1px solid grey;" onchange="showShopImage();"
                            ...
                            @for ($i=0; $i < 5 ;$i++ )
                                @if (getSetting()['shop'] == 'style'.$i)
                                <option selected="" value="style{{$i}}">Shop Page {{ $i+1 }}</option>

                                @else
                                <option value="style{{$i}}">Shop Page {{ $i+1 }}</option>
