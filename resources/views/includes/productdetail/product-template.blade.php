                        ...
                        <div class="from-group row mb-3">
                          ...
                          <div class="pro-rating col-12">
                            ...
                            <fieldset class="ratings">
                              ...
                              <label class="full fa" for="star5" title="Awesome - 5 stars"></label>
  
  
                              <input type="radio" id="star4" name="rating" value="4" class="rating">
                              <label class="full fa" for="star4" title="Pretty good - 4 stars"></label>
  
                              <input type="radio" id="star3" name="rating" value="3" class="rating">
                              <label class="full fa" for="star3" title="Pretty good - 3 stars"></label>
  
                              <input type="radio" id="star2" name="rating" value="2" class="rating">
                              <label class="full fa" for="star2" title="Meh - 2 stars"></label>
