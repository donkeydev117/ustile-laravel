...
<div>
            ...
            <div class="row">
                ...
                <div class="col-md-6 col-12">
                    ...
                    <ul class="nav nav-pills lang-tab" id="pills-tab1" role="tablist">
                        <li class="nav-item" v-for="language in languages" @click="setSelectedLanguage(language.id)" :key='language.id'>
                            <a class="nav-link btn-light shadow-none rounded-0" :class="language.id == selectedLanguage ? 'show active' : ''">
                    ...
                    <div class="row mt-2">
                        <div class="col-12">
                            <div class="tab-content lang-content" id="v-pills-tabContent">
                                <div class="tab-pane fade" v-for="(language, index) in languages" :key='language.id' :class="language.id == selectedLanguage ? 'show active' : ''">
                                    <h6 class="text-body">
                                        Product Name ( {{ language.language_name }} )
                                    </h6>
                                    <fieldset class="form-group mb-3">
                                        <input type="text" :name="'name' + index" v-on:input="setTitle($event.target.value, language.id)" class="form-control bg-transparent text-dark" id="basicInput" v-model="title[language.id]" placeholder="Product Name" />
                                    ...
                                    <fieldset class="form-group mb-3">
                                        <textarea id="label-textarea" :name="'desc' + index" v-on:input="setDesc($event.target.value, language.id)" rows="6" v-model="desc[language.id]" placeholder="Description" spellcheck="false" class="form-control" style="height: 130px"></textarea>
    ...
    <div class="row">
        <div class="col-12 d-flex justify-content-end">
            <a data-toggle="pill" href="#ad-info" class="btn btn-primary cta" @click.prevent="setActive('ad-info-tab')" :class="{ active: isActive('ad-info-tab') }">Continue</a>
        </div>
    </div>
